...
import { StudentSignoutModalComponent } from '@reslife/student-signout-ui';
...
export class StudentSignoutPageComponent implements OnInit {
  ...
  dialogTemplate!: TemplateRef<StudentSignoutModalComponent>;
  constructor(
    private ssd: StudentSignoutDataService,
  ...
  newSignout(): void {
    ...
    this.dialog
      ...
      .afterClosed()
      .subscribe((newSignout: StudentSignout | null) => {
        if (newSignout) {
  ...
  editSignout(signout: StudentSignout): void {
    ...
    this.dialog
      .open(this.dialogTemplate)
      .afterClosed()
      .subscribe((editedSignout: StudentSignout | null) => {
        if (editedSignout) {
